...
void CFiguras::casa(float altura, float largo, float profundidad, GLuint text)   //Funcion que crea la casa
{
	GLfloat vertice[8][3] = {   {-0.5*largo,0.5*altura,0.5*profundidad},//v1   0
							    {0.5*largo,0.5*altura,0.5*profundidad},//v2    1
							    {0.5*largo,-0.5*altura,0.5*profundidad},//v3     2
							    {-0.5*largo,-0.5*altura,0.5*profundidad},//v4    3
								{-0.5*largo,0.5*altura,-0.5*profundidad},//v5   4  
								{0.5*largo,0.5*altura,-0.5*profundidad},//v6    5
								{0.5*largo,-0.5*altura,-0.5*profundidad},//v7  6
								{-0.5*largo,-0.5*altura,-0.5*profundidad},//v8   7
							};


		glBindTexture(GL_TEXTURE_2D, text);
		/*glBegin(GL_POLYGON); //Cara atras
			glTexCoord2f(0.0f, 0.0f);   glVertex3fv(vertice[4]);
			glTexCoord2f(1.0f, 0.0f);	glVertex3fv(vertice[5]);
			glTexCoord2f(1.0f, 1.0f);	glVertex3fv(vertice[6]);
			glTexCoord2f(0.0f, 1.0f);	glVertex3fv(vertice[7]);
		...
		glBegin(GL_POLYGON); //Cara abajo
			...
			glTexCoord2f(0.0f, 1.0f);	glVertex3fv(vertice[3]);
		glEnd();
		glBegin(GL_POLYGON); //Cara enfrente
			glTexCoord2f(0.0f, 0.0f);   glVertex3fv(vertice[0]);
			glTexCoord2f(1.0f, 0.0f);	glVertex3fv(vertice[1]);
			glTexCoord2f(1.0f, 1.0f);	glVertex3fv(vertice[2]);
			glTexCoord2f(0.0f, 1.0f);	glVertex3fv(vertice[3]);
...
void CFiguras::plano(float altura, float largo, float profundidad, GLuint text) {
